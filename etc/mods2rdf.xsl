...
<!-- 
  ...
  enhanced matching of the root template to wrap RDF
  configured for infomotions
  Eric Lease Morgan (December 5, 2013)
...
<!DOCTYPE xsl:stylesheet [
    ...
    <!ENTITY barton   'http://infomotions.com/sandbox/liam/id'>
]>
